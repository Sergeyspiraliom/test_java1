...
public class groupcreationtest {
    ...
    public void testGroupCreation() {
        ...
        wd.findElement(By.name("group_name")).sendKeys("sertest1");
        ...
        wd.findElement(By.name("group_header")).sendKeys("sertest2");
        wd.findElement(By.name("group_footer")).click();
        wd.findElement(By.name("group_footer")).clear();
        wd.findElement(By.name("group_footer")).sendKeys("sertest3");
